...
-- question 1: create cac table with constraint and datatype
-- bang Department
...
INSERT INTO 
	Employee_Skill_Table 	(Employee_Number, 	Skill_code, 	Data_Registered)
VALUES
					(1,					'Java',			'2000/02/01'),
                    (2,					'PHP',			'2000/01/01'),
                    (3,					'Java',			'2000/03/01'),
...
SELECT Department.Department_Number, Department.Department_Name
FROM Department
...
SELECT Employee_Table.Employee_Number, Employee_Table.Employee_Name, Employee_Table.Department_Number
FROM Employee_Table
JOIN Department ON  Department.Department_Number = Employee_Table.Department_Number
GROUP BY Department_Number;
